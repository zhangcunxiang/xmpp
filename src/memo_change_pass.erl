...
pp(memo_change_pass, 5) ->
    [account, phone_number, country_code, newpass, vcode];
pp(_, _) -> no.
...
decode_memo_change_pass(__TopXMLNS, __Opts,
    ...
    {Account, Country_code, Phone_number, Newpass, Vcode} =
	decode_memo_change_pass_attrs(__TopXMLNS, _attrs,
				      undefined, undefined, undefined,
				      undefined, undefined),
    {memo_change_pass, Account, Phone_number, Country_code,
     Newpass, Vcode}.

decode_memo_change_pass_attrs(__TopXMLNS,
			      [{<<"account">>, _val} | _attrs], _Account,
			      Country_code, Phone_number, Newpass, Vcode) ->
    decode_memo_change_pass_attrs(__TopXMLNS, _attrs, _val,
				  Country_code, Phone_number, Newpass, Vcode);
decode_memo_change_pass_attrs(__TopXMLNS,
			      [{<<"country_code">>, _val} | _attrs], Account,
			      _Country_code, Phone_number, Newpass, Vcode) ->
    decode_memo_change_pass_attrs(__TopXMLNS, _attrs,
				  Account, _val, Phone_number, Newpass, Vcode);
decode_memo_change_pass_attrs(__TopXMLNS,
			      [{<<"phone_number">>, _val} | _attrs], Account,
			      Country_code, _Phone_number, Newpass, Vcode) ->
    decode_memo_change_pass_attrs(__TopXMLNS, _attrs,
				  Account, Country_code, _val, Newpass, Vcode);
decode_memo_change_pass_attrs(__TopXMLNS,
			      [{<<"newpass">>, _val} | _attrs], Account,
			      Country_code, Phone_number, _Newpass, Vcode) ->
    decode_memo_change_pass_attrs(__TopXMLNS, _attrs,
				  Account, Country_code, Phone_number, _val,
				  Vcode);
decode_memo_change_pass_attrs(__TopXMLNS,
			      [{<<"vcode">>, _val} | _attrs], Account,
			      Country_code, Phone_number, Newpass, _Vcode) ->
    decode_memo_change_pass_attrs(__TopXMLNS, _attrs,
				  Account, Country_code, Phone_number, Newpass,
				  _val);
...
encode_memo_change_pass({memo_change_pass, Account,
			 Phone_number, Country_code, Newpass, Vcode},
			__TopXMLNS) ->
    __NewTopXMLNS =
